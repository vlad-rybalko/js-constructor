...
import { TitleBlock, TextColumnsBlock, ImageBlock } from './classes/blocks';
import { css } from './utils';

const text: string = `
`;

export const model: (TitleBlock | ImageBlock | TextColumnsBlock)[] = [
    ...
    new TextColumnsBlock(
        ...
        {
            styles:
                'padding: 2rem 0; color: #fff;background: linear-gradient(to bottom, #8e2de2, #4a00e0);font-weight: bold; text-align: center',
        }
    ),
];
